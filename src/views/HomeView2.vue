<template>
  <div class="flex w-[100%] grow min-h-screen">
    <div class="flex flex-col bg-white mx-auto max-w-7xl grow px-3 py-2">
      ...
      ></div>
      <p class="py-2 font-bold text-[20px]">Thương hiệu</p>
      <div class="grid grid-cols-10 gap-2 w-full grow-0">
        <div
          v-for="(i, index) in counter.thuong_hieu_danh_sach"
          :key="index"
          class="flex justify-center items-center cursor-pointer border-[1px] rounded-md border-gray-[#e5e7eb] h-[34px] px-1 py-1"
        >
          <img :src="i.Avatar" />
        </div>
      </div>
      ...
      <p class="py-2 font-bold text-[20px]">Sản phẩm đang bán</p>
      <div class="grid grid-cols-5 gap-4 w-full grow-0">
        <a
          v-on:click="counter.F_chi_tiet_san_pham(1)"
          ...
          <div class="flex gap-2 w-full">
            ...
            <div class="w-full flex items-center justify-start font-semibold">
              <div class="relative">
                <p class="">{{ i.Price }}</p>
                <div
                  class="h-[0px] w-full border-[1px] border-slate-700 absolute top-[50%]"
                ></div>
              </div>
            </div>
          </div>
      ...
      <div class="grid grid-cols-5 gap-4 w-full grow-0">
        ...
        <!-- <div class="border-[1px] rounded-md border-slate-700 h-[430px]">01</div>
          <div class="border-[1px] rounded-md border-slate-700 h-[430px]">01</div>
          <div class="border-[1px] rounded-md border-slate-700 h-[430px]">01</div>
          <div class="border-[1px] rounded-md border-slate-700 h-[430px]">01</div>
          <div class="border-[1px] rounded-md border-slate-700 h-[430px]">01</div>
